...
const struct cdc_func_desc cdcacm_functional_descriptors = {
	.header = {
...
/* XXX This is the loopback code, insert future hax here! */
...
/*
 * TODO
 * Leaving this here for reference, once USB is working well remove this
int main(void)
{
